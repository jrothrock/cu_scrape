...
def SendMessage(sender, to, bcc, subject, msgHtml, msgPlain, attachmentFile=None):
    credentials = get_credentials()
    http = credentials.authorize(httplib2.Http())
    service = discovery.build('gmail', 'v1', http=http)
    if attachmentFile:
        message1 = createMessageWithAttachment(sender, to, bcc, subject, msgHtml, msgPlain, attachmentFile)
    else: 
...
def createMessageWithAttachment(
    sender, to, bcc, subject, msgHtml, msgPlain, attachmentFile):
